...
import { Mail, KeyRound, ArrowRight, AlertCircle, CheckCircle2, ShieldCheck, Sparkles } from 'lucide-react';
...
export function UserLoginPage() {
      ...
      if (res.success) {
        if (res.otp) {
          sendEmailJSVerification({
            to_email: email.trim(),
            user_name: name.trim() || 'Valued User',
            passcode: res.otp,
  ...
  const handleVerifyLogin = async (e) => {
    ...
    if (res.success) {
      ...
      setError(res.error || 'Invalid or expired login verification code.');
    }
  };
        ...
        <div className="max-w-md w-full">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 custom-shadow p-8">
            ...
            <div className="text-center mb-6">
              ...
              <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight">Customer Sign In</h1>
              <p className="mt-1 text-xs text-slate-500">
                Sign in with your verified email to access your personal dashboard and complaints.
              </p>
            </div>
              ...
              <form onSubmit={handleSendCode} className="space-y-4">
                ...
                <div className="pt-3 text-center">
                  <p className="text-xs text-slate-500">
                    Don't have an account yet? <Link to="/register" className="text-blue-600 font-bold hover:underline">Register here</Link>
                  </p>
                </div>
              </form>
            ) : (
