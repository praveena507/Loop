        ...
        <div className="max-w-lg w-full">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 custom-shadow p-8 text-center">
            ...
            <p className="mt-3 text-sm text-slate-600 leading-relaxed">
              Your grievance has been verified and registered in the LOOP Support system. Our support team is actively reviewing your case details.
            </p>

            {/* Complaint ID Display Box */}
            <div className="my-6 p-4 rounded-xl bg-slate-50 border border-slate-200 text-center">
              <p className="text-2xs uppercase tracking-wider font-bold text-slate-400">Assigned Complaint Ticket Number</p>
              <div className="mt-1 flex items-center justify-center space-x-2">
                ...
                <button
                  ...
                  className="p-1.5 text-slate-400 hover:text-slate-700 bg-white border border-slate-200 rounded-lg shadow-2xs transition-colors cursor-pointer"
                  title="Copy Complaint ID"
                >
                  {copied ? <Check className="w-4 h-4 text-emerald-600" /> : <Copy className="w-4 h-4" />}
                </button>
              </div>
              <p className="text-2xs text-slate-400 mt-1">Keep this Complaint ID to track status updates anytime.</p>
            </div>
