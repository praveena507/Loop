...
import { MessageSquarePlus, Search, Cpu, ShieldCheck, Zap, ArrowRight, CheckCircle2, FileText, Lock } from 'lucide-react';
...
export function LandingPage() {
  return (
    <div className="min-h-screen flex flex-col bg-slate-50">
      ...
      {/* Hero Section */}
      <section className="relative pt-16 pb-24 overflow-hidden bg-gradient-to-b from-blue-50/50 via-white to-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-6 text-lg text-slate-600 leading-relaxed">
              LOOP connects customer feedback directly to automated sentiment and priority intelligence. Submit your inquiry, receive real-time status updates, and track resolution progress with complete privacy.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200/80 card-hover">
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                Provide your location, complaint details, and category. Priority is calculated automatically.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200/80 card-hover">
              ...
              <h3 className="text-lg font-bold text-slate-900 mb-2">Email OTP Verify</h3>
              <p className="text-sm text-slate-600 leading-relaxed">
                Enter the instant verification code sent to your email to activate the complaint.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200/80 card-hover">
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                Monitor your status step-by-step and receive resolution notices directly to your email.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-slate-200 text-slate-700 text-xs font-bold mb-4">
                ...
                <span>Customer Privacy Priority</span>
              </div>
              <h2 className="text-3xl font-extrabold text-slate-900 tracking-tight mb-4">
                Designed for Uncompromising Privacy & Transparency
              </h2>
              <p className="text-slate-600 text-base leading-relaxed mb-6">
                LOOP operates with a strict separation boundary between public customer tracking and internal systems. As a customer, you get real-time transparency into your ticket status without exposure of personal staff identities or unnecessary noise.
              </p>
              <ul className="space-y-3">
                ...
                <li className="flex items-center text-sm font-semibold text-slate-800">
                  <CheckCircle2 className="w-5 h-5 text-emerald-500 mr-2.5 shrink-0" />
                  Complete protection of customer and internal privacy
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl border border-slate-200 custom-shadow space-y-6">
              <div className="flex items-center justify-between pb-4 border-b border-slate-100">
                <span className="text-sm font-bold text-slate-900">LOOP Platform Status</span>
              ...
              <div className="space-y-4 text-xs text-slate-600">
                <div className="p-4 rounded-xl bg-slate-50 border border-slate-100 flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5">Average AI processing time is under 1.5 seconds per complaint.</p>
                  </div>
                </div>
                <div className="p-4 rounded-xl bg-slate-50 border border-slate-100 flex items-start space-x-3">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200/80">
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                Click on "Track My Complaint" in the navigation bar, enter your assigned Complaint ID (e.g. LOOP-2026-849201) along with your verified email address.
              </p>
            </div>
