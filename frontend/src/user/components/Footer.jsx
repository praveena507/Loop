    ...
    <footer className="bg-slate-900 text-slate-400 py-12 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="/complaint" className="hover:text-blue-400 transition-colors">Submit Complaint</a></li>
              <li><a href="/track" className="hover:text-blue-400 transition-colors">Track Complaint Status</a></li>
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 leading-relaxed mb-3">
              All communications are dispatched securely via verified system channels.
            </p>
            <div className="inline-block px-3 py-1.5 bg-slate-800 rounded text-xs font-medium text-slate-300">
              LOOP Support Team
            </div>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center text-xs text-slate-400">
          <p>© {new Date().getFullYear()} LOOP Intelligence Platform. All rights reserved.</p>
